...
public class ProducerWSExample {
	...
	public static void main(String[] args) {
		...
		try {
			//Create Contact
			contactCreationReply = services.createContact(pdsHandle,contactDoc.toString());
		...
		try {
			...
			producerCreationReply = services.createProducer(pdsHandle, producerDoc.toString());
		...
		*/
			...
			try {
				producerAgentCreationReply = services.createProducerAgent(pdsHandle, producerAgentDoc.toString());
		 ...
		 */
			...
			linkProducerAgentReply = services.linkProducerAgentToProdcuer(pdsHandle, producerId.toString(),  producerAgentId.toString());
		 ...
		 * 8. Get Producer
		 */
			String getProducerReply = services.getProducerDetails(pdsHandle, String.valueOf(producerId));
